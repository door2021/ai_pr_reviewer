...
from app.models import User, Review, ChatMessage
...
async def create_review(
    ...
    background_tasks.add_task(process_ai_review, review.id, review_data.code_diff, review_data.original_code)
    
    return review

def process_ai_review(review_id: int, code_diff: str, original_code: str):
    ...
    try:
        ...
        analysis = asyncio.run(ai_engine.analyze_code(code_diff, original_code))
